...
#! nix-shell --pure --keep LD_LIBRARY_PATH --keep PRICE --keep NEXT_PRICE --keep CURRENT_ROOM_TEMP --keep NIGHT_DELTA -i dash -I channel:nixos-23.11-small -p nix dash bc curl cacert coreutils xxd netcat
set -eu
