...
# Block 1: System values (Read input register)
  ...
  SET_TEMPERATURE_FE7)            export OBJECTID=i@502;  export MULTIPLIER=0.1  ;; # °C
  ACTUAL_TEMPERATURE_FEK)         export OBJECTID=i@503;  export MULTIPLIER=0.1  ;; # °C
  SET_TEMPERATURE_FEK)            export OBJECTID=i@504;  export MULTIPLIER=0.1  ;; # °C
  RELATIVE_HUMIDITY)              export OBJECTID=i@505;  export MULTIPLIER=0.1  ;; # %
  DEW_POINT_TEMPERATURE)          export OBJECTID=i@506;  export MULTIPLIER=0.1  ;; # °C
  OUTSIDE_TEMPERATURE)            export OBJECTID=i@507;  export MULTIPLIER=0.1  ;; # °C
  ACTUAL_TEMPERATURE_HK_1)        export OBJECTID=i@508;  export MULTIPLIER=0.1  ;; # °C
  SET_TEMPERATURE_HK_1)           export OBJECTID=i@509;  export MULTIPLIER=0.1  ;; # °C
  SET_TEMPERATURE_HK_1_WPM)       export OBJECTID=i@510;  export MULTIPLIER=0.1  ;; # °C
  ACTUAL_TEMPERATURE_HK_2)        export OBJECTID=i@511;  export MULTIPLIER=0.1  ;; # °C
  SET_TEMPERATURE_HK_2)           export OBJECTID=i@512;  export MULTIPLIER=0.1  ;; # °C
  ACTUAL_FLOW_TEMPERATURE_WP)     export OBJECTID=i@513;  export MULTIPLIER=0.1  ;; # °C
  ACTUAL_FLOW_TEMPERATURE_NHZ)    export OBJECTID=i@514;  export MULTIPLIER=0.1  ;; # °C
  ACTUAL_FLOW_TEMPERATURE)        export OBJECTID=i@515;  export MULTIPLIER=0.1  ;; # °C
  ACTUAL_RETURN_TEMPERATURE)      export OBJECTID=i@516;  export MULTIPLIER=0.1  ;; # °C
  SET_FIXED_TEMPERATURE)          export OBJECTID=i@517;  export MULTIPLIER=0.1  ;; # °C
  ACTUAL_BUFFER_TEMPERATURE)      export OBJECTID=i@518;  export MULTIPLIER=0.1  ;; # °C
  SET_BUFFER_TEMPERATURE)         export OBJECTID=i@519;  export MULTIPLIER=0.1  ;; # °C
  HEATING_PRESSURE)               export OBJECTID=i@520;  export MULTIPLIER=0.01 ;; # bar
  FLOW_RATE)                      export OBJECTID=i@521;  export MULTIPLIER=0.1  ;; # l/min
  ACTUAL_TEMPERATURE_DHW)         export OBJECTID=i@522;  export MULTIPLIER=0.1  ;; # °C
  SET_TEMPERATURE_DHW)            export OBJECTID=i@523;  export MULTIPLIER=0.1  ;; # °C
  ACTUAL_TEMPERATURE_FAN)         export OBJECTID=i@524;  export MULTIPLIER=0.1  ;; # K
  SET_TEMPERATURE_FAN)            export OBJECTID=i@525;  export MULTIPLIER=0.1  ;; # K
  ACTUAL_TEMPERATURE_AREA)        export OBJECTID=i@526;  export MULTIPLIER=0.1  ;; # K
  SET_TEMPERATURE_AREA)           export OBJECTID=i@527;  export MULTIPLIER=0.1  ;; # K
  COLLECTOR_TEMPERATURE_SOL)      export OBJECTID=i@528;  export MULTIPLIER=0.1  ;; # °C
  CYLINDER_TEMPERATURE_SOL)       export OBJECTID=i@529;  export MULTIPLIER=0.1  ;; # °C
  RUNTIME_SOL)                    export OBJECTID=i@530;  export MULTIPLIER=1    ;; # h
  ACTUAL_TEMPERATURE_EXT)         export OBJECTID=i@531;  export MULTIPLIER=0.1  ;; # °C
  SET_TEMPERATURE_EXT)            export OBJECTID=i@532;  export MULTIPLIER=0.1  ;; # K
  APPLICATION_LIMIT_HZG)          export OBJECTID=i@533;  export MULTIPLIER=0.1  ;; # °C
  APPLICATION_LIMIT_WW)           export OBJECTID=i@534;  export MULTIPLIER=0.1  ;; # °C
  RUNTIME_EXT)                    export OBJECTID=i@535;  export MULTIPLIER=1    ;; # h
  SOURCE_TEMPERATURE)             export OBJECTID=i@536;  export MULTIPLIER=0.1  ;; # °C
  MIN_SOURCE_TEMPERATURE)         export OBJECTID=i@537;  export MULTIPLIER=0.1  ;; # °C
  SOURCE_PRESSURE)                export OBJECTID=i@538;  export MULTIPLIER=0.01 ;; # bar
  HOT_GAS_TEMPERATURE)            export OBJECTID=i@539;  export MULTIPLIER=0.1  ;; # °C
  HIGH_PRESSURE)                  export OBJECTID=i@540;  export MULTIPLIER=0.1  ;; # bar
  LOW_PRESSURE)                   export OBJECTID=i@541;  export MULTIPLIER=0.1  ;; # bar
  RETURN_TEMPERATURE_HP1)         export OBJECTID=i@542;  export MULTIPLIER=0.1  ;; # °C
  FLOW_TEMPERATURE_HP1)           export OBJECTID=i@543;  export MULTIPLIER=0.1  ;; # °C
  HOT_GAS_TEMPERATURE_HP1)        export OBJECTID=i@544;  export MULTIPLIER=0.1  ;; # °C
  LOW_PRESSURE_HP1)               export OBJECTID=i@545;  export MULTIPLIER=0.01 ;; # bar
  MEAN_PRESSURE_HP1)              export OBJECTID=i@546;  export MULTIPLIER=0.01 ;; # bar
  HIGH_PRESSURE_HP1)              export OBJECTID=i@547;  export MULTIPLIER=0.01 ;; # bar
  WP_WATER_FLOW_RATE_HP1)         export OBJECTID=i@548;  export MULTIPLIER=0.1  ;; # l/min
  RETURN_TEMPERATURE_HP2)         export OBJECTID=i@549;  export MULTIPLIER=0.1  ;; # °C
  FLOW_TEMPERATURE_HP2)           export OBJECTID=i@550;  export MULTIPLIER=0.1  ;; # °C
  HOT_GAS_TEMPERATURE_HP2)        export OBJECTID=i@551;  export MULTIPLIER=0.1  ;; # °C
  LOW_PRESSURE_HP2)               export OBJECTID=i@552;  export MULTIPLIER=0.01 ;; # bar
  MEAN_PRESSURE_HP2)              export OBJECTID=i@553;  export MULTIPLIER=0.01 ;; # bar
  HIGH_PRESSURE_HP2)              export OBJECTID=i@554;  export MULTIPLIER=0.01 ;; # bar
  WP_WATER_FLOW_RATE_HP2)         export OBJECTID=i@555;  export MULTIPLIER=0.1  ;; # l/min
  RETURN_TEMPERATURE_HP3)         export OBJECTID=i@556;  export MULTIPLIER=0.1  ;; # °C
  FLOW_TEMPERATURE_HP3)           export OBJECTID=i@557;  export MULTIPLIER=0.1  ;; # °C
  HOT_GAS_TEMPERATURE_HP3)        export OBJECTID=i@558;  export MULTIPLIER=0.1  ;; # °C
  LOW_PRESSURE_HP3)               export OBJECTID=i@559;  export MULTIPLIER=0.01 ;; # bar
  MEAN_PRESSURE_HP3)              export OBJECTID=i@560;  export MULTIPLIER=0.01 ;; # bar
  HIGH_PRESSURE_HP3)              export OBJECTID=i@561;  export MULTIPLIER=0.01 ;; # bar
  WP_WATER_FLOW_RATE_HP3)         export OBJECTID=i@562;  export MULTIPLIER=0.1  ;; # l/min
  RETURN_TEMPERATURE_HP4)         export OBJECTID=i@563;  export MULTIPLIER=0.1  ;; # °C
  FLOW_TEMPERATURE_HP4)           export OBJECTID=i@564;  export MULTIPLIER=0.1  ;; # °C
  HOT_GAS_TEMPERATURE_HP4)        export OBJECTID=i@565;  export MULTIPLIER=0.1  ;; # °C
  LOW_PRESSURE_HP4)               export OBJECTID=i@566;  export MULTIPLIER=0.01 ;; # bar
  MEAN_PRESSURE_HP4)              export OBJECTID=i@567;  export MULTIPLIER=0.01 ;; # bar
  HIGH_PRESSURE_HP4)              export OBJECTID=i@568;  export MULTIPLIER=0.01 ;; # bar
  WP_WATER_FLOW_RATE_HP4)         export OBJECTID=i@569;  export MULTIPLIER=0.1  ;; # l/min
  RETURN_TEMPERATURE_HP5)         export OBJECTID=i@570;  export MULTIPLIER=0.1  ;; # °C
  FLOW_TEMPERATURE_HP5)           export OBJECTID=i@571;  export MULTIPLIER=0.1  ;; # °C
  HOT_GAS_TEMPERATURE_HP5)        export OBJECTID=i@572;  export MULTIPLIER=0.1  ;; # °C
  LOW_PRESSURE_HP5)               export OBJECTID=i@573;  export MULTIPLIER=0.01 ;; # bar
  MEAN_PRESSURE_HP5)              export OBJECTID=i@574;  export MULTIPLIER=0.01 ;; # bar
  HIGH_PRESSURE_HP5)              export OBJECTID=i@575;  export MULTIPLIER=0.01 ;; # bar
  WP_WATER_FLOW_RATE_HP5)         export OBJECTID=i@576;  export MULTIPLIER=0.1  ;; # l/min
  RETURN_TEMPERATURE_HP6)         export OBJECTID=i@577;  export MULTIPLIER=0.1  ;; # °C
  FLOW_TEMPERATURE_HP6)           export OBJECTID=i@578;  export MULTIPLIER=0.1  ;; # °C
  HOT_GAS_TEMPERATURE_HP6)        export OBJECTID=i@579;  export MULTIPLIER=0.1  ;; # °C
  LOW_PRESSURE_HP6)               export OBJECTID=i@580;  export MULTIPLIER=0.01 ;; # bar
  MEAN_PRESSURE_HP6)              export OBJECTID=i@581;  export MULTIPLIER=0.01 ;; # bar
  HIGH_PRESSURE_HP6)              export OBJECTID=i@582;  export MULTIPLIER=0.01 ;; # bar
  WP_WATER_FLOW_RATE_HP6)         export OBJECTID=i@583;  export MULTIPLIER=0.1  ;; # l/min
  ACTUAL_TEMPERATURE_HC1)         export OBJECTID=i@584;  export MULTIPLIER=0.1  ;; # °C
  SET_TEMPERATURE_HC1)            export OBJECTID=i@585;  export MULTIPLIER=0.1  ;; # °C
  RELATIVE_HUMIDITY_HC1)          export OBJECTID=i@586;  export MULTIPLIER=0.1  ;; # %
  DEW_POINT_TEMPERATURE_HC1)      export OBJECTID=i@587;  export MULTIPLIER=0.1  ;; # °C
  ACTUAL_TEMPERATURE_HC2)         export OBJECTID=i@588;  export MULTIPLIER=0.1  ;; # °C
  SET_TEMPERATURE_HC2)            export OBJECTID=i@589;  export MULTIPLIER=0.1  ;; # °C
  RELATIVE_HUMIDITY_HC2)          export OBJECTID=i@590;  export MULTIPLIER=0.1  ;; # %
  DEW_POINT_TEMPERATURE_HC2)      export OBJECTID=i@591;  export MULTIPLIER=0.1  ;; # °C
  ACTUAL_TEMPERATURE_HC3)         export OBJECTID=i@592;  export MULTIPLIER=0.1  ;; # °C
  SET_TEMPERATURE_HC3)            export OBJECTID=i@593;  export MULTIPLIER=0.1  ;; # °C
  RELATIVE_HUMIDITY_HC3)          export OBJECTID=i@594;  export MULTIPLIER=0.1  ;; # %
  DEW_POINT_TEMPERATURE_HC3)      export OBJECTID=i@595;  export MULTIPLIER=0.1  ;; # °C
  ACTUAL_TEMPERATURE_HC4)         export OBJECTID=i@596;  export MULTIPLIER=0.1  ;; # °C
  SET_TEMPERATURE_HC4)            export OBJECTID=i@597;  export MULTIPLIER=0.1  ;; # °C
  RELATIVE_HUMIDITY_HC4)          export OBJECTID=i@598;  export MULTIPLIER=0.1  ;; # %
  DEW_POINT_TEMPERATURE_HC4)      export OBJECTID=i@599;  export MULTIPLIER=0.1  ;; # °C
  ACTUAL_TEMPERATURE_HC5)         export OBJECTID=i@600;  export MULTIPLIER=0.1  ;; # °C
  SET_TEMPERATURE_HC5)            export OBJECTID=i@601;  export MULTIPLIER=0.1  ;; # °C
  RELATIVE_HUMIDITY_HC5)          export OBJECTID=i@602;  export MULTIPLIER=0.1  ;; # %
  DEW_POINT_TEMPERATURE_HC5)      export OBJECTID=i@603;  export MULTIPLIER=0.1  ;; # °C
  SET_TEMPERATURE_CC_1)           export OBJECTID=i@604;  export MULTIPLIER=0.1  ;; # °C
  SET_TEMPERATURE_CC_2)           export OBJECTID=i@605;  export MULTIPLIER=0.1  ;; # °C
  SET_TEMPERATURE_CC_3)           export OBJECTID=i@606;  export MULTIPLIER=0.1  ;; # °C
  SET_TEMPERATURE_CC_4)           export OBJECTID=i@607;  export MULTIPLIER=0.1  ;; # °C
  SET_TEMPERATURE_CC_5)           export OBJECTID=i@608;  export MULTIPLIER=0.1  ;; # °C

# Block 2: System parameters (Read/write holding register)
  OPERATING_MODE)                 export OBJECTID=h@1501; export MULTIPLIER=1    ;;
  COMFORT_TEMPERATURE_HC1)        export OBJECTID=h@1502; export MULTIPLIER=0.1  ;; # °C
  ECO_TEMPERATURE_HC1)            export OBJECTID=h@1503; export MULTIPLIER=0.1  ;; # °C
  HEATING_CURVE_RISE_HC1)         export OBJECTID=h@1504; export MULTIPLIER=0.01 ;;
  COMFORT_TEMPERATURE_HC2)        export OBJECTID=h@1505; export MULTIPLIER=0.1  ;; # °C
  ECO_TEMPERATURE_HC2)            export OBJECTID=h@1506; export MULTIPLIER=0.1  ;; # °C
  HEATING_CURVE_RISE_HC2)         export OBJECTID=h@1507; export MULTIPLIER=0.01 ;;
  FIXED_VALUE_OPERATION)          export OBJECTID=h@1508; export MULTIPLIER=0.1  ;; # °C
  DUAL_MODE_TEMP_HZG)             export OBJECTID=h@1509; export MULTIPLIER=0.1  ;; # °C
  COMFORT_TEMPERATURE_DHW)        export OBJECTID=h@1510; export MULTIPLIER=0.1  ;; # °C
  ECO_TEMPERATURE_DHW)            export OBJECTID=h@1511; export MULTIPLIER=0.1  ;; # °C
  DHW_STAGES)                     export OBJECTID=h@1512; export MULTIPLIER=1    ;;
  DUAL_MODE_TEMP_WW)              export OBJECTID=h@1513; export MULTIPLIER=0.1  ;; # °C
  SET_FLOW_TEMPERATURE_AC)        export OBJECTID=h@1514; export MULTIPLIER=0.1  ;; # °C
  FLOW_TEMP_HYSTERESIS_AC)        export OBJECTID=h@1515; export MULTIPLIER=0.1  ;; # K
  SET_ROOM_TEMPERATURE_AC)        export OBJECTID=h@1516; export MULTIPLIER=0.1  ;; # °C
  SET_FLOW_TEMPERATURE_FC)        export OBJECTID=h@1517; export MULTIPLIER=0.1  ;; # °C
  FLOW_TEMP_HYSTERESIS_FC)        export OBJECTID=h@1518; export MULTIPLIER=0.1  ;; # K
  SET_ROOM_TEMPERATURE_FC)        export OBJECTID=h@1519; export MULTIPLIER=0.1  ;; # °C
