...
(window as any).automower = (query: string) => load('automower', query);
(window as any).ping = (query: string) => load('ping', query);
(window as any).speed = (query: string) => load('speed', query);